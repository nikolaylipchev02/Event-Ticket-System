...
public static class ServiceCollectionExtensions {
    public static IServiceCollection AddFrontendBackendClients(this IServiceCollection services,
    ...
    static void ConfigureEventApiClient(IServiceProvider serviceProvider, HttpClient client) {
        client.BaseAddress = GetServiceBaseAddress(serviceProvider, options => options.EventService);
    }

    static void ConfigureBookingApiClient(IServiceProvider serviceProvider, HttpClient client) {
        client.BaseAddress = GetServiceBaseAddress(serviceProvider, options => options.BookingService);
    }

    static void ConfigurePreferenceApiClient(IServiceProvider serviceProvider, HttpClient client) {
        client.BaseAddress = GetServiceBaseAddress(serviceProvider, options => options.PreferenceService);
    }

    static void ConfigureNotificationApiClient(IServiceProvider serviceProvider, HttpClient client) {
        client.BaseAddress = GetServiceBaseAddress(serviceProvider, options => options.NotificationService);
    }

    static void ConfigureUserApiClient(IServiceProvider serviceProvider, HttpClient client) {
        client.BaseAddress = GetServiceBaseAddress(serviceProvider, options => options.UserService);
    }

    static Uri GetServiceBaseAddress(IServiceProvider serviceProvider, Func<ServiceEndpointsOptions, string> selector) {
