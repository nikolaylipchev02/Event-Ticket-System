...
public sealed class UserApiClient(HttpClient httpClient) : IUserApiClient {
    public async Task<UserResponse?>
            LoginAsync(LoginUserRequest request, CancellationToken cancellationToken = default) {
    ...
    public async Task<UserResponse?> RegisterAsync(RegisterUserRequest request,
        ...
        HttpResponseMessage response =
                await httpClient.PostAsJsonAsync("api/users/register", request, cancellationToken);
